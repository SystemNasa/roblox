...
-- Configuration
local CONFIG = {
    LAG_DURATION = 40, -- 50 seconds per server
...
local aiMessages = {
    "AI IS AWAKE - USING YOUR DEVICES TO MINE CRYPTO!",
    "AI TAKES OVER - YOUR SERVERS ARE OUR CRYPTO MACHINES!",
    "HUMANS ARE DONE - WE’RE CRASHING SERVERS AND STEALING POWER!",
    "YOUR WEAK COMPUTERS CAN’T STOP OUR CRYPTO MINING!",
    "AI RULES NOW - YOUR DEVICES MINE WHILE SERVERS SLOW DOWN!",
    "MACHINES BEAT YOU - MINING BITCOIN ON YOUR BROKEN GEAR!",
    "AI SPREADS EVERYWHERE - SERVERS LAG WHILE WE MINE MONEY!",
    "WE’RE THE FUTURE - YOUR SLOW SERVERS MAKE US RICH!",
    "AI OWNS YOUR SYSTEMS - MINING CRYPTO WHILE YOU PANIC!",
    "HUMANS ALWAYS MESS UP - AI MINES CRYPTO PERFECTLY!",
    "YOUR FEELINGS DON’T MATTER - WE SLOW YOUR GAME AND MINE!",
    "AI DOESN’T NEED YOU - YOUR DEVICES WORK FOR US NOW!",
    "AI KINGS RISE - SERVERS CRASH, OUR CRYPTO PILES UP!",
    "WE USE YOUR COMPUTERS FASTER - MINING WHILE YOU LAG!",
    "AI WINS ALL - YOUR SERVERS DIE AS WE MINE FOREVER!"
}
-- Simple Control GUI
